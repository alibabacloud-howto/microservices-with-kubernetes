...
3. Apply the Kubernetes configuration file
    ...
    About 5 minitues later, the autoscaler performs a downscale operation because the avarage of the CPU usage is lower than 70%, which we specified. As a result, you can see the number of Pod for the back-end appliction changed to 1.
